package com.accengage.mapreduce.avro;
...
//Added mStartPosition and mEndPosition getters
public abstract class AvroPositionRecordReaderBase<K, V, T> extends RecordReader<K, V> {
  private static final Logger LOG = LoggerFactory.getLogger(AvroPositionRecordReaderBase.class);
   ...
   */
  protected AvroPositionRecordReaderBase(Schema readerSchema) {
